% This is "PAM2009-sample.tex" copied from "www2005-sample.tex" V1.2 January 26 2004
% This file should be compiled with V1.4 of "PAM2009-submission.class"
%
% This example file demonstrates the use of the 'PAM2009-submission.cls'
...
% The 'PAM2009-submission.cls' file will produce a similar-looking,
...
\documentclass{PAM2009-submission}

\begin{document}
%
\title{Alternate {\ttlit ACM} SIG Proceedings Paper in LaTeX
Format\titlenote{(Produces the PAM2009-specific release, location and
copyright information). For use with
PAM2009-submission.cls V1.4. Supported by ACM.}}
...
\alignauthor Ben Trovato\titlenote{Dr.~Trovato also works at...}\\
...
The PAM2009-submission.cls file itself is chock-full of succinct
